package org.anonymous.wallets.fullnode.messaging;
 ...
 * <p>
 * ~/.AnonymousSwingWallet/messaging - root dir
 * ~/.AnonymousSwingWallet/messaging/messagingoptions.json - options
 * ~/.AnonymousSwingWallet/messaging/ownidentity.json - own identity
 * ~/.AnonymousSwingWallet/messaging/ownidentity.json.bak.1 - own identity most recent backup
 * ~/.AnonymousSwingWallet/messaging/ownidentity.json.bak.9 - own identity oldest backup
 * ~/.AnonymousSwingWallet/messaging/contact_XXXX - a single contact named 0000 to 9999
 * ~/.AnonymousSwingWallet/messaging/contact_XXXX/identity.json - contact's identity
 * ~/.AnonymousSwingWallet/messaging/contact_XXXX/sent - sent messages dir
 * ~/.AnonymousSwingWallet/messaging/contact_XXXX/received - received messages dir
 * ~/.AnonymousSwingWallet/messaging/ignored_contacts - dir where ignored msg identities reside
 * ~/.AnonymousSwingWallet/messaging/ignored_contacts/UUID.json - single ignored identity.
 * <p>
...
public class MessagingStorage {
    ...
    // ~/.AnonymousDesktopWallet/messaging/contact_XXXX
    ...
    // ~/.AnonymousDesktopWallet/messaging/contact_XXXX/sent
