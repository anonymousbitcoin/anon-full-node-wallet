package org.anonymous.wallets.fullnode.util;

import org.anonymous.wallets.fullnode.daemon.CommandExecutor;
...
public class OSUtil
{
    ...
    // Returns the name of the anond server - may vary depending on the OS.
    ...
    // Returns the name of the anon-cli tool - may vary depending on the OS.
    public static String getZCashCli()
    {
        String zcashcli = "anon-cli";
            ...
            throws IOException
    {
        ...
        final String JAR_NAME = "AnonymousDesktopWallet.jar";
            ...
            throws IOException
    {
        ...
        {
            return new File(System.getProperty("user.home") + "/Library/Application Support/Anon").getCanonicalPath();
        } else if (os == OS_TYPE.WINDOWS)
        {
            return new File(System.getenv("APPDATA") + "\\Anon").getCanonicalPath();
        } else
        {
            return new File(System.getProperty("user.home") + "/.anon").getCanonicalPath();
        }
    }
            ...
            throws IOException
    {
        ...
        if (os == OS_TYPE.MAC_OS)
        {
            dir = new File(userHome, "Library/Application Support/AnonDesktopWallet");
        } else if (os == OS_TYPE.WINDOWS)
        {
            dir = new File(System.getenv("LOCALAPPDATA") + "\\AnonDesktopWallet");
        } else
        {
            dir = new File(userHome.getCanonicalPath() + File.separator + ".anonDesktopWallet");
        }
    ...
    // Can be used to find anond/anon-cli if it is not found in the same place as the wallet JAR
    // Null if not found
            ...
            throws IOException
    {
        ...
        String ZCashLocationDir = System.getProperty("anon.location.dir");
