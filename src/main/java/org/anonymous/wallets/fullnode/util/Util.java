...
public class Util {
  ...
  public static final String PROVING_KEY_PATH_URL = "https://storage.googleapis.com/anon-sprout-key/sprout-proving.key";
  ...
  public static String local(String key) {
    if (bundle == null) {
      try {
        ...
        bundle = ResourceBundle.getBundle("anonwalletui", locale);
      } catch (MissingResourceException e) {
        bundle = ResourceBundle.getBundle("anonwalletui", Locale.ENGLISH);
      }
    }
  ...
  public static boolean isZAddress(String address) {
    return (address != null) &&
      (address.startsWith("zk") || address.startsWith("zt")) &&
      (address.length() > 40);
  }
