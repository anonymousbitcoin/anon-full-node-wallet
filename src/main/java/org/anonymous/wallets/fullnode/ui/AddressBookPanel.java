...
public class AddressBookPanel extends JPanel {
    ...
    private static final String LOCAL_MENU_SEND_ANON = Util.local("LOCAL_MENU_SEND_ANON");
    ...
    private static final String LOCAL_MSG_SEND_ANON = Util.local("LOCAL_MSG_SEND_ANON");
    ...
    private JPanel buildButtonsPanel() {
        ...
        sendCashButton = new JButton(LOCAL_MENU_SEND_ANON);
    ...
    private class AddressMouseListener extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            JMenuItem sendCash = new JMenuItem(LOCAL_MSG_SEND_ANON + " " +entry.name);
    ...
    private class AddressListSelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            sendCashButton.setText(LOCAL_MSG_SEND_ANON + " " + name);
