...
public class ANONClientCaller {
    ...
    public synchronized WalletBalance getWalletInfo()
        ...
        balance.masternodeCollateral = Double.valueOf(objResponse.getString("masternode_collaterals", "-1"));
        ...
        balance.unconfirmedMasternodeCollateral = Double.valueOf(objResponse.getString("masternode_collaterals", "-1"));
